...
class GameplaySettingsSubState extends BaseOptionsMenu
{
	public function new()
	{
		...
		var option:Option = new Option('Judgement counter', 'If checked, shows your current judgements on the left side of the screen.', 'judgementCounter',
			'bool', false);
		addOption(option);

		var option:Option = new Option('Disable Reset Button', "If checked, pressing Reset won't do anything.", 'noReset', 'bool', false);
		addOption(option);
		var option:Option = new Option('Sudden Death', "If checked, missing will cause a loss.", 'noMiss', 'bool', false);
		addOption(option);
		var option:Option = new Option('No Fail', "If checked, losing all health will NOT cause a loss.", 'noFail', 'bool', false);
		addOption(option);
		var option:Option = new Option('Mirror Mode', "If checked, notes positions will be mirrored", 'mirrorMode', 'bool', false);
		addOption(option);

		/*var option:Option = new Option('Clear system:',
			"Which SDVX clear system should the game use?",
			'sdvxClear',
			'string',
			'EFFECTIVE',
			['EFFECTIVE', 'EXCESSIVE']);
			addOption(option); */
		/*var option:Option = new Option('L.N. system:', "Which L.N. scoring system should the game use?", 'lnMode', 'string', 'Rating',
			['Osu!', 'Etterna', 'Rating']);
		addOption(option);*/
