...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		for (i in 0...WeekData.weeksList.length)
		{
			...
			if (weekIsLocked(i) /*&& !Achievements.isAchievementUnlocked('week1_pass')*/)
			{
	...
	override function update(elapsed:Float)
	{
		...
		/*if(curWeek != 1 || Achievements.isAchievementUnlocked('week1_pass'))
	...
	function selectWeek()
	{
		if (/*Achievements.isAchievementUnlocked('week1_pass') ||*/ !weekIsLocked(curWeek))
		{
	...
	function changeDifficulty(change:Int = 0):Void
	{
		...
		if (curDifficulty >= CoolUtil.difficulties.length - 1 /*&& curWeek != 1*/)
			curDifficulty = 0;
		/*if(curWeek == 1)
		{
			curDifficulty = 4;
