...
class Achievements
{
	public static var achievementsStuff:Array<Dynamic> = [
		...
		[
			"Nice",
			"Get Less Than 69 Misses In Week1 in Maximum Difficulty",
			'week1_less_than_69_misses',
			false
		],
		[
			"Skill Issue",
			"Change Difficulty To Novice Mid Song (Lol, Skill Issue)",
			'noob',
			false
		],
		["IKADKNKNF IT'S A SCRETTTTTT!!!!!", "Pass Fin4le", 'battleblock_reference', false],
		["According To All Known Laws Of Aviation",	"Pass び", 'bypass',false],
		["If You Gaze Into An Abyss",	"Pass A Song In Mirror Mode", 'mirror',false],
		["Try Harder Mr. Showoff","Beat All Songs Without Missing",'wixx_Sucks',false],
		["Don't Tell Combro","Find The K.M.D Secret Menu",'kmd',false],
		["The Completionist","Get ALL Achievements",'completion',false],
